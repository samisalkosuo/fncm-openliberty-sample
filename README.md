...
Minimal OpenLiberty skeleton.

Authentication uses CLoud Pak auth
...
# Build & run container
podman build -t fncm-openliberty-starter:latest .
podman run -p 9080:9080 --env-file=config.env fncm-openliberty-starter:latest
```
